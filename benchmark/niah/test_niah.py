...
def _load_or_generate_data(
    ...
    """Load JSONL test data or generate samples for the requested context lengths and depths."""
    if not online_test:
...
def test(
    ...
    max_context_k_tokens: int = 1000_000_000,
    ...
    """Evaluate needle retrieval using existing or generated long-context samples."""
