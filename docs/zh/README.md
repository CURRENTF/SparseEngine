...
- [快速开始](getting_started/README.md)：安装、checkpoint 下载和最小 Sparse-Engine 使用示例。
...
- [Sparse-Engine 控制图](design/control-map.md)

## 基准测试运行手册

- [基准测试目录](benchmarking/README.md)
- [效率与吞吐性能套件](benchmarking/efficiency.md)
- [Sparse-Engine 回归测试](benchmarking/sparseengine-regression-tests.md)
