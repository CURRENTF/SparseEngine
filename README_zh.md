...
<div align="center">
  ...
  <img src="docs/assets/sparse_decode_efficiency_lowbs.png" alt="Qwen3 和 GLM 解码吞吐量随并发数的变化" style="width:100%; height:auto;">
...
H100 80GB，128K 输入 / 2K 输出。从上到下依次展示：各方法最大已测批量下的解码吞吐量、低并发下的绝对吞吐量，以及相同并发数下相对 vLLM Vanilla 的吞吐量提升（vLLM 为 0% 基线）。
归档图中的 SVLLM 指 SparseEngine。详见[测量口径与图表说明](scripts/official_experiments/sparse_decode_efficiency/README.md#readme-figures)。
